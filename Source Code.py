    ...
    if choice == 1:
        ...
        try:
            ...
            if size > 0:
                ...
                print(f"{Fore.RED}You need to scrape before running this command (Resets each time)")
                time.sleep(3)
                main()
        except:
            print(f"{Fore.RED}You need to scrape first before running this command (Resets each time)")
            time.sleep(3)
            main()
        f = open("users.txt","r")
        for id in f:
